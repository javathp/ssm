...
<div class="list-container have-subhead">
    ...
    <!--页面右侧-->
    <div class="main">
        <form class="form-horizontal" enctype="multipart/form-data"  action="${ctx}/house/edit" method="post" modelAttribute="house">
            ...
            <div>
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="hName" value="${house.hName}" placeholder="">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" name="hBak">${house.hBak}</textarea>
                        </td>
                    </tr>
