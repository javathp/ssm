...
<div class="list-container have-subhead">
    ...
    <!--页面右侧-->
    <div class="main">
        <form class="form-horizontal" enctype="multipart/form-data"  action="${ctx}/building/edit" method="post" modelAttribute="building">
            ...
            <div>
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="bName" value="${building.bName}" placeholder="">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" name="bBak">${building.bBak}</textarea>
                        </td>
                    </tr>
