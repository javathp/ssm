        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var i=0; i<obj.length; i++){
                    ...
                    a += "<tr>"
                    +"<td>"+item.tName+"</td>"
                    +"<td>"+item.tSpace+"平米</td>"
                    +"<td>"+item.tBak+"</td>"
                    +"<td>"
                    +"<a href='${ctx}/type/toLoad?tId="+item.tId+"' class='btn btn-xs btn-primary'><span class='glyphicon glyphicon-pencil'></span>"
                    +"编辑"
                    +"</a>"+"&nbsp;"
                    +"<a href='${ctx}/type/toDel?tId="+item.tId+"' class='btn btn-xs btn-danger'><span class='glyphicon glyphicon-remove'></span>"
                    +"删除"
                    +"</a>"
                    +"</td>"
                    +"</tr>";
