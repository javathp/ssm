...
<nav class="navbar navbar-fixed-top subhead">
    ...
    <div class="list-container have-subhead">
        ...
        <div class="main">
            ...
            <form class="form-horizontal" enctype="multipart/form-data"  action="${ctx}/building/add" method="post">
                ...
                <div>
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="bName" value="" placeholder="">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" name="bBak"></textarea>
                            </td>
                        </tr>
