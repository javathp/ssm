...
<%@include file="top.jsp"%>
    ...
    <div class="list-container have-subhead">
        ...
        <div class="main">
            ...
            <form class="form-horizontal" enctype="multipart/form-data"  action="${ctx}/house/add" method="post">
                ...
                <div>
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="hName" placeholder="">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" name="hBak"></textarea>
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    $(" input[ name='hName' ] ").on('blur',function(){
        var name=$(" input[ name='hName' ] ").val();
        $.ajax({
            url:"${ctx}/house/checkName?hName="+name+"",
            type:'post',
