...
<nav class="navbar navbar-fixed-top subhead">
    ...
    <div class="list-container have-subhead">
        ...
        <!--页面右侧-->
        <div class="main">
            <form class="form-horizontal" enctype="multipart/form-data"  action="${ctx}/type/add" method="post">
                ...
                <div>
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="tName" value="" placeholder="">
                            </td>
                        </tr>
                        <tr>
                            <td class="form-title">
                            ...
                            <td>
                                <input type="text" class="form-control" name="tSpace" value="" placeholder="">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" name="tBak"></textarea>
                            </td>
                        </tr>
