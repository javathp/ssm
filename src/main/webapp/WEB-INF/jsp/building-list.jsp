...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            url:"${ctx}/building/BuildingtoList",
            type:'post',
            success:function(data){
                ...
                for(var i=0; i<obj.length; i++){
                    ...
                    a += "<tr>"
                        ...
                        +"<td>"+item.bBak+"</td>"
                        +"<td>"
                        +"<a href='${ctx}/building/toLoad?bId="+item.bId+"' class='btn btn-xs btn-primary'><span class='glyphicon glyphicon-pencil'></span>"
                        +"编辑"
                        +"</a>"+"&nbsp;"
                        +"<a href='${ctx}/building/toDel?bId="+item.bId+"' class='btn btn-xs btn-danger'><span class='glyphicon glyphicon-remove'></span>"
                        +"删除"
                        +"</a>"
                        +"</td>"
                        +"</tr>";
