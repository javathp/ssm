            ...
            success:function(data){
                ...
                for(var i=0; i<obj.length; i++){
                    ...
                    a += "<tr>"
                        ...
                        +"<td>"+item.hBak+"</td>"
                        +"<td>"
                        +"<a href='${ctx}/house/toLoad?hId="+item.hId+"' class='btn btn-xs btn-primary'><span class='glyphicon glyphicon-pencil'></span>"
                        +"编辑"
                        +"</a>"+"&nbsp;"
                        +"<a href='${ctx}/house/toDel?hId="+item.hId+"' class='btn btn-xs btn-danger'><span class='glyphicon glyphicon-remove'></span>"
                        +"删除"
                        +"</a>"
                        +"</td>"
                        +"</tr>";
