...
<div class="list-container have-subhead">
    ...
    <!--页面右侧-->
    <div class="main">
        <form class="form-horizontal" enctype="multipart/form-data"  action="${ctx}/fee/edit" method="post" modelAttribute="cost">
            ...
            <div>
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="cName" value="${cost.cName}" placeholder="">
                        </td>
                    </tr>
                    <tr>
                        <td class="form-title">
                        ...
                        <td>
                            <input type="text" class="form-control" name="cStandard" value="${cost.cStandard}" placeholder="">
                        </td>
                    </tr>
                    <tr>
                        <td class="form-title">
                        ...
                        <td>
                            <textarea class="form-control" name="cBak">${cost.cBak}</textarea>
                        </td>
                    </tr>
                    </tbody>
                </table>
