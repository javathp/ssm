...
<%@include file="top.jsp"%>
    ...
    <div class="list-container have-subhead">
        ...
        <!--页面右侧-->
        <div class="main">
            <form class="form-horizontal" enctype="multipart/form-data"  action="${ctx}/fee/add" method="post">
                ...
                <div>
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="cName" value="" placeholder="">
                            </td>
                        </tr>
                        <tr>
                            <td class="form-title">
                            ...
                            <td>
                                <input type="text" class="form-control" name="cStandard" value="" placeholder="">
                            </td>
                        </tr>
                        <tr>
                            <td class="form-title">
                            ...
                            <td>
                                <textarea class="form-control" name="cBak"></textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
